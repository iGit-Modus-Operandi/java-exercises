package gameAlgorithms.scrabbleSolver;
...
public class ScrabbleSolver {
  ...
  public static void main(String[] args) throws IOException {
    ...
    BufferedReader reader = new BufferedReader(new FileReader("M:\\texts\\drafts\\academics\\auto-didact\\java\\exercises\\java-exercises\\src\\gameAlgorithms\\scrabbleSolver\\dictionary.txt"));
    ...
    for (String currentWord = reader.readLine(); currentWord != null; currentWord = reader.readLine()){
      ...
      for (Character character: currentWordMap.keySet()){
        ...
        int letterCharCount = lettersCountMap.containsKey(character) ?
